...
router.get('/', (req, res) => {
    const arr = [{ 'name': { '$regex': req.query.name, '$options': 'i' } }, { 'continent': req.query.continent }, { 'sem1_weather': req.query.weather }, { 'language': { '$regex': req.query.language, '$options': 'i' } }, { $or: [{ 'sum_domi': req.query.domi }, { 'domi': req.query.domi }] }]
    const searcharray = []
